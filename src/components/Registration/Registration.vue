<template>
  <div class="container">
    ...
    <div class="registration-wrapper">
      <!-- Контейнер для блока регистрации и преимуществ -->
      <div class="registration-container">
        ...
        <div class="registration">
          ...
          <div v-if="!isRegistered">
            ...
            <div>
              <input 
                ...
                @blur="validateEmail"
              />
              <p v-if="emailError" style="color: red;">Неверный формат почты</p>
              ...
              <p v-if="passwordError" style="color: red;">Пароль должен содержать не менее 6 символов</p>
              <!-- Кнопка "Войти" с новым стилем -->
          ...
          <div v-if="isRegistered">
            ...
            />
            <p v-if="newEmailError" style="color: red;">В почте необходим символ @</p>
            <div class="password-input">
              <input 
            ...
            <p v-if="newPasswordError" style="color: red;">Пароль должен содержать не менее 6 символов</p>
            <div class="password-input">
              <input 
            ...
            ></vue3-recaptcha2>
            <!-- Кнопка "Зарегистрироваться" с новым стилем -->
